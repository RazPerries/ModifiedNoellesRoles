...
public class ShortFuseFirecrackerEntity extends Entity {
    public ShortFuseFirecrackerEntity(EntityType<?> type, World world) {
        super(type, world);
    }
    ...
    public void tick() {
        ...
        if (!(this.getWorld() instanceof ServerWorld serverWorld)) {
            ...
            if (this.age >= SHORTFUSED_FIRECRACKER_TIMER) {
