...
public class NoellesRolesComponents implements EntityComponentInitializer, WorldComponentInitializer {
    ...
    public void registerEntityComponentFactories(@NotNull EntityComponentFactoryRegistry registry) {
        ...
        registry.beginRegistration(PlayerEntity.class, SwapperPlayerComponent.KEY).respawnStrategy(RespawnCopyStrategy.NEVER_COPY).end(SwapperPlayerComponent::new);
    ...
    public void registerWorldComponentFactories(WorldComponentFactoryRegistry worldComponentFactoryRegistry) {
        ...
        worldComponentFactoryRegistry.register(BellringerTimeComponent.KEY, BellringerTimeComponent::new);
    }
}