...
public class BellringerTimeComponent implements AutoSyncedComponent, ServerTickingComponent {
    public static final ComponentKey<BellringerTimeComponent> KEY = ComponentRegistry.getOrCreate(Identifier.of(Noellesroles.MOD_ID, "bellringer"), BellringerTimeComponent.class);

    public final World world;
    public int elapsedTicks;

    public BellringerTimeComponent(World world) {
        this.world = world;
        this.elapsedTicks = 0;
    }
